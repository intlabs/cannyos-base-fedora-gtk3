#!/bin/sh
#
# CannyOS cannyos-base-fedora-gtk3 container build script
#
...
#
clear
curl https://raw.githubusercontent.com/intlabs/cannyos-base-fedora-gtk3/master/CannyOS/CannyOS.splash
#     *****************************************************
#     *                                                   *
#     *        _____                    ____  ____        *
...
sudo docker build -t="intlabs/cannyos-base-fedora-gtk3" github.com/intlabs/cannyos-base-fedora-gtk3
...
sudo mkdir -p "/CannyOS/build/cannyos-base-fedora-gtk3"
# Ensure that there it is clear
sudo rm -r -f "/CannyOS/build/cannyos-base-fedora-gtk3/*"

# Remove any existing containers
sudo docker stop cannyos-base-fedora-gtk3
